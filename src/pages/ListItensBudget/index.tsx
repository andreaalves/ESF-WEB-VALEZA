...
import { getBudgetItensColumn } from '../../utils/getBudgetItensColumn';
...
export default function ListItensBudget() {
  ...
  useEffect(() => {
    api
      .get(`/api-essencial/v1/orcamento/${params.id}`)
      .then((response) => {
              ...
              {user.role === 'ROLE_MANAGER' &&
                ...
                orders.length !== 0 && (
                  <Button
                    ...
                    cursor="pointer"
                    onClick={() => history.push('/listar/orcamento')}
                  >
                    VOLTAR
                  </Button>
                )}
            ...
            <Flex alignItems="center" justifyContent="center">
              {isLoading ? (
                ...
                <>
                  {orders.length === 0 ? (
                    <Flex>
                      <Text color="orange.200">Sem orçamentos para exibir</Text>
                    </Flex>
                  ) : (
